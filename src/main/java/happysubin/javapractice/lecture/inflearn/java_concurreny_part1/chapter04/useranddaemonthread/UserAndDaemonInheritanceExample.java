package happysubin.javapractice.lecture.inflearn.java_concurreny_part1.chapter04.useranddaemonthread;
...
public class UserAndDaemonInheritanceExample {
    ...
    public static void main(String[] args) {
        ...
        Thread userThread = new Thread(() -> {
            ...
            System.out.println("사용자 스레드의 데몬 상태: " + Thread.currentThread().isDaemon()); //false
        });
        ...
        Thread daemonThread = new Thread(() -> {
            ...
            System.out.println("데몬 스레드의 데몬 상태: " + Thread.currentThread().isDaemon()); //true
        });
